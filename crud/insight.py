...
class InsightCRUD:
    ...
    def save_danger_menu_strategy(self, db: Session, insight: dict, menu_id: int):
        db.add(DangerMenuStrategy(summary=insight['summary'], detail=insight['analysis_detail'], guide=insight['action_guide'], completion_phrase=insight['completion_phrase'], menu_id=menu_id))
