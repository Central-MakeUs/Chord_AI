...
from chain.response_schema import StrategyResponse, DangerStrategyResponse
...
def get_system_prompt(context: str, parser: PydanticOutputParser) -> str:
    # get_format_instructions()의 중괄호를 이스케이프 처리
    ...
    completion_phrase: 15자 이내 1문장

    {format_instructions}
    """

DANGER_MENU_CONTEXT = "제공된 메뉴 데이터들을 기반으로 각 메뉴의 개선 가이드들을 작성해주세요"
CAUTION_MENUS_CONTEXT = "제공된 마진 등급 주의 메뉴들의 데이터들을 기반으로 종합 개선 가이드를 작성해주세요"
